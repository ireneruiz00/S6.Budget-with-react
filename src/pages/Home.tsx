...
function Home() {
  ...
  return (
    <div className="w-[280px] h-[280px] mx-auto mt-3 bg-[#DFC1C9] rounded-full p-8 flex flex-col justify-center items-center text-center shadow-lg sm:w-[550px] sm:h-[550px] ">
